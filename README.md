...
Blue nodes are internal pages, green nodes are internal resource files (anything that isn't HTML), orange nodes are external pages, and magenta nodes are pages with errors. Hover over nodes to see URLs and specific errors (e.g. 404, 500, timeout).
